...
<div class="cantainer" align="center">
    ...
    <form action="<?php echo U('Article/update');?>" enctype="multipart/form-data" method="post">
        <div class = "form-group">
            文章标题：
            <input type="text" value="<?php echo ($info['title']); ?>" name="edit_title">
            <input type="submit" class="btn btn-success" value="保存" >
            <input type="hidden" name="id" value="<?php echo ($info['id']); ?>">
        </div>
        <div class = "form-group html_thumb" >
            缩略图：
            <input type="file" id="input-file-now" class="dropify" name="thumb" data-default-file="/thinkphp_3.2.3_full/Public/<?php echo ($info['thumb']); ?>" />

        </div>

        <div>
         内容: <textarea class="text_area" name="edit_content" id="editor"><?php echo ($info['content']); ?></textarea>
        </div>
    </form>
</div>
</body>
<script type="text/javascript">
window.UEDITOR_HOME_URL = "//thinkphp_3.2.3_full/Public/lib/utf8-php/";
var ue = UE.getEditor('editor');  
$('.dropify').dropify();
</script>

<script src="http://libs.baidu.com/jquery/2.1.1/jquery.min.js"></script>
<script src="/thinkphp_3.2.3_full/Public/lib/dropify/dist/js/dropify.min.js"></script>
<script>
