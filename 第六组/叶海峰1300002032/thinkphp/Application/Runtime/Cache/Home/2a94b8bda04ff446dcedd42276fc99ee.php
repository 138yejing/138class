...
<div class="centont">
        <div id="Slide1" class="zy-Slide">
                    ...
                    <section>></section>
                        <ul>
                            <li><a href=""><img src="/thinkphp_3.2.3_full/Public/san/img/4.png" /></a></li>
                            <li><a href=""><img src="/thinkphp_3.2.3_full/Public/san/img/3.png" /></a></li>
                            <li><a href=""><img src="/thinkphp_3.2.3_full/Public/san/img/5.jpg" /></a></li>
                        </ul>
            </div>
    </div>
   <div id="content">
            <div class="introduce">
                <div class="practise">
                    ...
                    <div class="item_class">
                        <a href="#" >
						<img src="/thinkphp_3.2.3_full/Public/san/img/prictise1.jpg" height="124" width="100%" />
						</a>
                    ...
                    <div class="item_class">
						...
						<a href ="#">
						<img src="/thinkphp_3.2.3_full/Public/san/img/prictise2.jpg" height="124" width="100%" />
						</a>
                        <div class="item_class_intro">
                            <h3>所向披靡的响应式开发</h3>
                    ...
                    <div class="item_class">
                        <a href="#">
						<img src="/thinkphp_3.2.3_full/Public/san/img/prictise3.jpg" height="124" width="100%" />
						</a>
                        <div class="item_class_intro">
                            <h3>飞速上手的跨平台App开发</h3>
                    ...
                    <div class="item_class">
					<a href="#">
                        <img src="/thinkphp_3.2.3_full/Public/san/img/prictise4.jpg" height="124" width="100%" />
						</a>
                        <div class="item_class_intro">
                    ...
                    <div class="item_class" style="margin-right: 0;">
                        <a href="#">
						<img src="/thinkphp_3.2.3_full/Public/san/img/prictise5.jpg" height="124" width="100%" />
						</a>
                        <div class="item_class_intro">
                ...
                <div class="free">
                    ...
                    <div class="item_class">
					<a href="#">
                        <img src="/thinkphp_3.2.3_full/Public/san/img/free1.jpg" height="124" width="100%" />
						</a>
                        <div class="item_class_intro">
                            <h3>
                                <i>初</i>
                    ...
                    <div class="item_class">
					<a href="#">
                        <img src="/thinkphp_3.2.3_full/Public/san/img/free2.jpg" height="124" width="100%" />
						</a>
                        <div class="item_class_intro">
                            <h3>
                                <i>初</i>
                    ...
                    <div class="item_class">
                        <img src="img/free3.jpg" height="124" width="100%" />
                        <div class="item_class_intro">
                            <h3>
                                <i>初</i>
                                 PS入门教程——新手过招
                    ...
                    <div class="item_class">
					<a href ="#">
                        <img src="/thinkphp_3.2.3_full/Public/san/img/free4.jpg" height="124" width="100%" />
						</a>
                        <div class="item_class_intro">
                            <h3>
                                <i>初</i>
                    ...
                    <div class="item_class" style="margin-right: 0;">
						...
						<a href ="#">
						<img src="/thinkphp_3.2.3_full/Public/san/img/free5.jpg" height="124" width="100%" />
						</a>
                        <div class="item_class_intro">
                            <h3>
                                <i>初</i>
            ...
            <div class="web_learn">
                ...
                <div class="web_m2">
					...
					<a href="#">
                        <img src="img/web1.jpg" height="124" width="100%" />
						</a>
                        <div class="item_class_intro">
                            <h3>
                                <i>中</i>
					...
					<a href="#">
                        <img src="/thinkphp_3.2.3_full/Public/san/img/web2.jpg" height="124" width="100%" />
						</a>
                        <div class="item_class_intro">
                            <h3>
                                <i>初</i>
				...
				<a href ="#">
                    <img src="/thinkphp_3.2.3_full/Public/san/img/web3.jpg" height="124" width="100%" />
					</a>
                    <div class="item_class_intro">
                        <h3>
                                <i>高</i>
